...
contract OpenSourceChainToken3 is StandardToken ,SafeMath {
    // metadata
    string  public constant name = "OpenSourceChain Token";
    string  public constant symbol = "OSCH3";                                
    ...
    // constructor
    function OpenSourceChainToken3(address _owner) public {
        owner = _owner;
        totalSupply = formatDecimals(80000000000);
    ...
    function increaseSupply(uint256 mintedAmount) onlyOwner {
        uint256 value = formatDecimals(mintedAmount);
